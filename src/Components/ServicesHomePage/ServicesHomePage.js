...
const ServicesHomePage = () => {
  return (
    <div className="w-[100%] sm:w-[100%] 2xl:w-[85%] px-48 max-xl:px-24 flex flex-col gap-5 max-lg:px-20 max-md:px-10 max-sm:px-2 mx-auto 2xl:mx-auto 2xl:justify-center 2xl:items-center 2xl:min-w-screen 2xl:px-[1rem]">
      <div>
      ...
      <div className="flex items-center flex-wrap justify-center gap-x-5 gap-y-10 max-lg:gap-y-3 2xl:text-2xl 2xl:w-full">
        <div className="flex flex-col gap-y-4 items-center justify-between w-[100%] h-[25rem] min-h-fit sm:w-[40%] lg:w-[32%]">
          ...
          <Link
            to={"/"}
            className="bg-[#1ac648] hover:bg-[#23d051] transition-all duration-200 text-white px-3 py-3  sm:px-2 sm:py-3 text-center rounded-lg shadow-[1px_1px_10px_rgba(0,0,0,.5)] -tracking-[1.3px]"
          >
