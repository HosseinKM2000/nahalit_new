...
function Edite({ goalGallery , setEdite }) {
  ...
  return (
    <div className='flex flex-col w-full 2xl:w-[70%] opacity-motion'>
            ...
            <div className='w-full bg-[#C0D9DB] p-2 flex items-center justify-between'>
                ...
                <MdCancel className='text-red-600 font-bold text-3xl transition-all hover:text-red-500' onClick={(e)=>setEdite({status:false,value:''})}/>
            </div>
