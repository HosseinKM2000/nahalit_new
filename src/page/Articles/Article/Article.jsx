    ...
    <div className='flex flex-col sm:flex-row mt-5 w-11/12 overflow-x-hidden text-right gap-2 sm:pr-3'>
        ...
        <div className='flex flex-col lg:w-[80%]'>
            ...
            <div className='flex flex-col mt-10 2xl:gap-20 items-start'>
              ...
              {/* article-information */}
              <div className='flex flex-col sm:flex-row mt-3 2xl:text-3xl gap-5 sm:gap-10 text-gray-88'>
              ...
              <div className='rulls mt-20 text-gray-66 relative'>
                <h2 className='text-base 2xl:text-sm font-bold w-fit'>قوانین ارسال دیگاه در سایت</h2>
                  ...
                  >
                    {
                      articles.map(article => (
                        <SwiperSlide className='SwiperSlide'>
                          <div className='flex flex-col 2xl:mb-10 gap-2 2xl:gap-12 rounded-md overflow-hidden border-2 border-for-border'>
                            ...
                            <div className='flex flex-col py-5 text-sm 2xl:text-4xl'>
                              <p className='line-clamp-4 text-gray-66 leading-5 px-4 suggest-text 2xl:text-2xl text-justify mb-3'>{article.explain}</p>
                              <Link className='text-pink hover:text-light-pink mr-2 cursor-pointer font-bold 2xl:text-2xl' to={{pathname:`/articles/article`,search:`?name=${article.title}`}}>جزئیات بیشتر</Link>
                            </div>
                            <div className='flex text-sm py-2 2xl:text-2xl 2xl:justify-between border-2 border-for-border flex-row gap-10 sm:gap-2'>
              ...
              <div className='flex flex-col sm:flex-row w-full sm:w-auto  items-center 2xl:p-12 gap-4 sm:gap-32 py-5 px-4 my-10 text-white bg-light-blue'>
               <span className='text-xs sm:text-sm flex items-center 2xl:text-2xl'>راه آسان تری برای ارتباط با کاربرانمان پیدا کرده ایم :)</span>
        ...
        {/* left side */}
        <div className='flex gap-10 flex-col mt-10 lg:w-[20%]'>
          <div className='flex gap-2 flex-col 2xl:gap-12'>
            <div className='flex flex-row items-center gap-2 2xl:gap-12 text-sm text-gray-66'>
              ...
              <span className='2xl:text-2xl'>لینک کوتاه:</span>
            </div>
            <div className='flex flex-row gap-2'>
              ...
              <input className='border-2 2xl:text-2xl text-gray-66 rounded border-for-border py-2 pl-1 pr-4 outline-none text-sm' type="url" name="" id="" value={shortLink}/>
            </div>
          </div>
          <div className='flex flex-col items-end text-sm'>
            <span className='py-2 px-4 border-2 border-gray-white 2xl:text-3xl rounded-t-md font-bold'>کلمات کلیدی بلاگ</span>
