      ...
      <div className='Graphic-content Services-style  flex flex-col items-center gap-10 mb-10'>
        ...
        <div className='flex flex-col gap-14 px-1'>
            ...
            <div className='flex flex-col-reverse sm:flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_1} alt="UI-UX" className='w-[15rem] 2xl:w-[500px]'  whileInView={{x:[-700,0],opacity:[0,1]}} transition={{duration:0.9}} viewport={{once:true}}/>
            </div>
            <motion.div whileInView={{x:[-1000,0]}} transition={{duration:0.9}} viewport={{once:true}} className='flex flex-col sm:flex-row gap-5 items-center'>
                <img src={Img_2} alt="template" className='w-[15rem] 2xl:w-[500px]'/>
                <div>
            ...
            <div className='flex flex-col-reverse sm:flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_3} alt="teaser" className='w-[15rem] 2xl:w-[400px]' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-col sm:flex-row gap-5 items-center'>
                <motion.img src={Img_4} alt="character" className='w-[15rem] 2xl:w-[500px]' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}/>
            ...
            <div className='flex flex-col-reverse sm:flex-row gap-5 items-center'>
                ...
                <motion.img src={Img_5} alt="catalog-design" className='w-[15rem] 2xl:w-[500px]' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
            </div>
            <div className='flex flex-col sm:flex-row gap-5 items-center'>
                <motion.img src={Img_6} alt="logo-design" className='w-[15rem] 2xl:w-[500px]' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
                <motion.div whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
            ...
            <div className='flex flex-col sm:flex-row gap-5 items-center'>
                <motion.img src={Img_8} alt="catalog" className='w-[15rem] 2xl:w-[500px]' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}/>
                <motion.div whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1}} viewport={{once:true}}>
            ...
            <motion.div className='flex flex-col-reverse sm:flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                ...
                <img src={Img_9} alt="" className='w-[15rem] 2xl:w-[500px]'/>
            </motion.div>
            <motion.div className='flex flex-col sm:flex-row gap-5 items-center' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <img src={Img_10} alt="visit-card" className='w-[15rem] 2xl:w-[500px]'/>
                <div>
            ...
            <motion.div className='flex flex-col-reverse sm:flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                ...
                <img src={Img_11} alt="img" className='w-[15rem] 2xl:w-[500px]'/>
            </motion.div>
            <motion.div className='flex flex-col sm:flex-row gap-5 items-center' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <img src={Img_12} alt="poster-and-banner" className='w-[15rem] 2xl:w-[500px]'/>
                <div>
            ...
            <motion.div className='flex flex-col-reverse sm:flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                ...
                <img src={Img_13} alt="UI" className='w-[15rem] 2xl:w-[500px]'/>
            </motion.div>
            <motion.div className='flex flex-col sm:flex-row gap-5 items-center' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <img src={Img_14} alt="template-design" className='w-[15rem] 2xl:w-[500px]'/>
                <div>
            ...
            <motion.div className='flex flex-col-reverse sm:flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                ...
                <img src={Img_15} alt="instagram" className='w-[15rem] 2xl:w-[500px]'/>
            </motion.div>
            <motion.div className='flex flex-col sm:flex-row gap-5 items-center' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <img src={Img_16} alt="arrival-page" className='w-[15rem] 2xl:w-[500px]'/>
                <div>
            ...
            <motion.div className='flex flex-col-reverse sm:flex-row gap-5 items-center' whileInView={{x:[1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                ...
                <img src={Img_17} alt="slider-deisgn" className='w-[15rem] 2xl:w-[500px]'/>
            </motion.div>
            <motion.div className='flex flex-col sm:flex-row gap-5 items-center' whileInView={{x:[-1000,0],opacity:[0,1]}} transition={{duration:1.5}} viewport={{once:true}}>
                <img src={Img_18} alt="banner" className='w-[15rem] 2xl:w-[500px] 2xl:h-32'/>
                <div>
