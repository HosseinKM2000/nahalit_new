  ...
  return (
    ...
    <div className='flex flex-col w-full'>
        <div  className='flex flex-col mt-10 2xl:gap-20 items-start'>
          ...
          <div className='w-full h-[30rem] bg-no-repeat bg-gray-88 sm:h-[40rem] xl:w-[70rem] xl:h-[70rem] max-w-full overflow-hidden cursor-zoom-in' onMouseOut={(e)=>mouseOutHandler(e)} onMouseMove={(e)=>mouseMoveHandler(e)} style={{backgroundImage:`url(${goalProduct?.img})`,backgroundSize:'cover'}}>
          </div>
