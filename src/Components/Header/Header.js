    ...
    <>
      ...
      <div className="min-w-full">
        <div className="flex justify-center mt-3 text-center mx-auto gap-x-12 2xl:text-[1.5rem]">
          <p className="font-[shabnamLight]  leading-10 text-[#707070]">
            آدرس : تهران میدان فردوسی خیابان ایرانشهر بین سمیه و طالقانی مجتمع تجاری میلاد واحد 9
          </p>
          <p className="font-[shabnamLight] leading-10 text-[#707070]">پشتیبانی 24 ساعته : 02188867940 – 09927674217</p>
        </div>
        <div className="flex justify-center mt-10">
          <Link>
            <div className="border-l-2 gap-1 border-dotted border-[#d7f0d6] px-4 py-3 flex flex-col items-center justify-center">
              ...
              <p className="text-[#191919] 2xl:text-[1.5rem] font-[shabnamthin] tracking-tighter">قالب وردپرس</p>
            </div>
          </Link>
          <Link>
            <div className="border-l-2 gap-1 border-dotted border-[#d7f0d6] px-4 py-3 flex flex-col items-center justify-center">
              <AiFillHtml5 className="text-[2.5rem] text-[#57C053] hover:text-[#6ade66] transition-all duration-300" />
              <p className="text-[#191919] 2xl:text-[1.5rem] font-[shabnamThin] tracking-tighter">قالب html</p>
            </div>
          </Link>
          <Link>
            <div className="border-l-2 gap-1 border-dotted border-[#d7f0d6] px-4 py-3 flex flex-col items-center justify-center">
              <FaWordpressSimple className="text-[2.5rem] text-[#57C053] hover:text-[#6ade66] transition-all duration-300" />
              <p className="text-[#191919] 2xl:text-[1.5rem] font-[shabnamThin] tracking-tighter">پلاگین وردپرس</p>
            </div>
          </Link>
          <Link>
            <div className="px-4 py-3 flex gap-1 flex-col items-center justify-center">
              ...
              <p className="text-[#191919] 2xl:text-[1.5rem] font-[shabnamThin] tracking-tighter">محصولات اپلیکیشن</p>
            </div>
          </Link>
        </div>
        ...
        <div className="flex justify-center mt-1 font-[shabnamMedium]">
          <div className="text-[#7c7c7c] 2xl:text-2l text-sm flex 2xl:gap-x-[1rem] gap-x-[1rem] px-2 2xl:gap-16">
            <ul className="flex justify-start items-center gap-x-4 2xl:gap-x-10 lg:whitespace-nowrap">
              <li className="2xl:text-2xl text-[#171717] text-sm">
              ...
              >
                <li className="2xl:text-2xl text-[#171717] text-sm"><Link>محصولات</Link></li>
                <RiArrowDownSLine/>
                <div
                  onMouseEnter={clickEntershowslide}
                  className={
                  ...
                  <ul className="p-5 bg-white">
                    ...
                    >
                      <div className="relative">
                        <Link>
                          <p className="2xl:text-2xl text-[#171717] text-sm font-[shabnamMedium]">سایت های آماده</p>
                        </Link>
                        <div
                          onMouseEnter={clickEntershowslide6}
                          className={
                        ...
                        >
                          <Link className="2xl:text-2xl text-[#171717] text-sm">سایت آماده لاراول</Link>
                        </div>
                      </div>
                      <MdKeyboardArrowLeft />
                    </li>
                    ...
                    >
                      <Link className="2xl:text-2xl text-[#171717] text-sm">پلاگین وردپرس</Link>
                      <MdKeyboardArrowLeft />
                      <div
                        onMouseEnter={clickEntershowslide7}
                        className={
                      ...
                      >
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">پلاگین امنیتی</p>
                        </Link>
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">پلاگین مدیریتی</p>
                        </Link>
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">پلاگین کاربردی</p>
                        </Link>
                      </div>
                    </li>
                    <li
                    ...
                    >
                      <Link className="2xl:text-2xl text-[#171717] text-sm">قالب html</Link>
                      <MdKeyboardArrowLeft />
                      <div
                        onMouseEnter={clickEntershowslide8}
                        className={
                      ...
                      >
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">قالب شخصی</p>
                        </Link>
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">قالب شرکتی</p>
                        </Link>
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">قالب فروشگاهی</p>
                        </Link>
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">قالب خبری</p>
                        </Link>
                      </div>
                    </li>
                    <li
                    ...
                    >
                      <Link className="2xl:text-2xl text-[#171717] text-sm">اپلیکیشن موبایل</Link>
                      <MdKeyboardArrowLeft />
                      <div
                        onMouseEnter={clickEntershowslide9}
                        className={
                      ...
                      >
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">اپلیکیشن اندروید</p>
                        </Link>
                      </div>
                    </li>
                    <li
                    ...
                    >
                      <Link className="2xl:text-2xl text-[#171717] text-sm">اسکریپت ها</Link>
                      <MdKeyboardArrowLeft />
                      <div
                        onMouseEnter={clickEntershowslide10}
                        className={
                      ...
                      >
                        <Link className="px-4 py-1">
                          <p className="2xl:text-2xl font-[shabnamMedium] text-[#171717] text-sm">اسکریپت لاراول</p>
                        </Link>
                      </div>
                    </li>
                  </ul>
              ...
              <li>
                <Link to="/order" className="2xl:text-2xl text-[#171717] text-sm">ثبت سفارش</Link>
              </li>
              <li>
                <Link className="2xl:text-2xl text-[#171717] text-sm">بلاگ</Link>
              </li>
              ...
              >
                <Link to="/" className="2xl:text-2xl text-[#171717] text-sm">نمونه کارها</Link>
                <RiArrowDownSLine />
                <div
                  onMouseEnter={clickEntershowslide2}
                  className={
                ...
                >
                  ...
                  <ul className="p-5 bg-white">
                    ...
                    >
                      <Link to="/" className="2xl:text-xl text-[#171717] text-sm">نمونه کار گرافیک</Link>
                      <MdKeyboardArrowLeft />
                      <div
                        onMouseEnter={clickEntershowslide11}
                        className={
                      ...
                      >
                        <Link to="/MotionGraphics" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار موشن گرافیک</p>
                        </Link>
                        <Link to="/UI_UX" className="px-4 py-1">
                          <p className="2xl:text-xl font-[shabnamMedium] text-[#171717] text-sm">نمونه کار UI/UX</p>
                        </Link>
                        <Link to="/Brochure" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار بروشور</p>
                        </Link>
                        <Link to="/Poster" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار پوستر</p>
                        </Link>
                        <Link to="/Catalog" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار کاتالوگ</p>
                        </Link>
                        <Link to="/BusinessCard" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار کارت ویزیت</p>
                        </Link>
                        <Link to="/Logo" className="px-4 py-1">
                          <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار لوگو</p>
                        </Link>
                      </div>
                    </li>
                    <Link to="/Premiere">
                      <li className="flex items-center justify-start py-3">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار پریمیر</p>
                      </li>
                    </Link>
                    <Link>
                      <li
                      ...
                      >
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار طراحی سایت</p>
                        <MdKeyboardArrowLeft />
                        <div
                          onMouseEnter={clickEntershowslide12}
                          className={
                        ...
                        >
                          <Link className="px-4 py-1" to="/WebsiteDesignPortfolio">
                            <p className="2xl:text-2xl text-[#171717] font-[shabnamMedium] text-sm">PHP (Laravel)</p>
                          </Link>
                        </div>
                      </li>
                    </Link>
                    <Link to="/Aplication">
                      <li className="flex items-center justify-between py-3">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار اپلیکیشن</p>
                      </li>
                    </Link>
                    <Link to="/Seo">
                      <li className="flex items-center justify-between py-3">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار سئو</p>
                      </li>
                    </Link>
                    <Link to="/Voicing">
                      <li className="flex items-center justify-between py-3">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">نمونه کار تدوین و صدا گذاری</p>
                      </li>
                    </Link>
                  </ul>
                </div>
              ...
              <li>
                <Link to="/LoginLearn" className="2xl:text-2xl text-[#171717] text-sm">آموزش ورود</Link>
              </li>
              <li>
                <Link to="/recruitment" className="2xl:text-2xl text-[#171717] text-sm">استخدام</Link>
              </li>
              <li
                className="flex items-center gap-x-1 relative"
              ...
              >
                <Link className="2xl:text-2xl text-[#171717] text-sm">خدمات ما</Link>
                <RiArrowDownSLine />
                <div
                  onMouseEnter={clickEntershowslide3}
                  className={
                  ...
                  <ul className="px-5 py-3 bg-white  w-fit flex flex-col items-start 2xl:gap-3">
                    <Link to="/EecoSaleWeb">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">فروش سایت اختصاصی و اقتصادی</p>
                      </li>
                    </Link>
                    <Link to="/SsaleWeb">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">فروش قالب سایت</p>
                      </li>
                    </Link>
                    <Link to="/SsaleWebExclusive">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">طراحی سایت اختصاصی</p>
                      </li>
                    </Link>
                    <Link to="/Sseo">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">خدمات وبسایت و سئو وب سایت</p>
                      </li>
                    </Link>
                    <Link to="/SworkService">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">خدمات کسب و کار</p>
                      </li>
                    </Link>
                    <Link to="/SsocialMedia">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">خدمات شبکه های اجتماعی</p>
                      </li>
                    </Link>
                    <Link to="/SmotionGhraphic">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">موشن گرافیک</p>
                      </li>
                    </Link>
                    <Link to="/Sproposal">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">تدوین پروپوزال</p>
                      </li>
                    </Link>
                    <Link to="/S_Aplication">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">اپلیکیشن موبایل</p>
                      </li>
                    </Link>
                    <Link to="/Spremier">
                      <li className="flex items-center justify-start py-1">
                        <p className="2xl:text-xl text-[#171717] font-[shabnamMedium] text-sm">خدمات پریمیر، تدوین فیلم</p>
                      </li>
                    </Link>
                    <div>
                      <li
                      ...
                      >
                        <Link to="/SsoundEditing" className="2xl:text-2xl text-[#171717] text-sm">خدمات تدوین صدا و صداگذاری</Link>
                        <MdKeyboardArrowLeft />
                        <div
                          onMouseEnter={clickEntershowslide13}
                          className={
                        ...
                        >
                          <Link to="/Sgraphic" className="px-4 py-1">
                            <p className="2xl:text-2xl font-[shabnamMedium] text-[#171717] text-sm">خدمات گرافیکی</p>
                          </Link>
                        </div>
                      </li>
                    </div>
