  ...
  return (
    <div className='w-full'>
        <div className='w-full flex justify-center items-center flex-col py-10 gap-y-5'>
            ...
            <Link to={'/login'}>
               <button className='py-1 font-[shabnambold] text-[#37c085] transition-all duration-500 hover:bg-[#37c085] hover:text-white rounded-sm border-[3px] w-[15rem] sm:w-[30rem] lg:w-[40rem] border-[#37c085] '>رفتن به بخش لاگین</button>
            </Link>
        </div>
    </div>
  )
