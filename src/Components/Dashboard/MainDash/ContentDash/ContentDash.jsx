...
function ContentDash() {
  ...
  return (
    <div ref={bodyRef} className='bg-[#363d4f] flex justify-center scroll-dash-content w-full lg:w-[75%] xl:w-[80%] 2xl:w-[85%] h-[90%] max-h-screen overflow-y-scroll relative'>
        {
          currentContent
        }
    </div>
