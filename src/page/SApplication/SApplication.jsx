    ...
    <main>
      ...
      <div className='MobileApplication-content Services-style flex flex-col items-center gap-10 mb-10'>
        ...
        <div className='flex flex-col w-full sm:my-[3rem] m-0'>
            ...
            <EndBox2  content={{link:"/workSamples/Application",p:'جهت مشاهده نمونه کارهای  اپلیکیشن موبایل  توسط تیم نهال آی تی از طریق لینک زیر اقدام کنید',b:'مشاهده نمونه کار اپلیکیشن موبایل'}}/>
        </div>
      <div>
        <FixedIcon />
      </div>
