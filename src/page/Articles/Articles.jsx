        ...
        <div className='flex sm:flex-wrap flex-col sm:flex-row justify-center gap-3 sm:gap-3 items-center'>
            {
                currentItems.map((article , index) => (
                    <div className='w-[17rem] sm:w-[45%] overflow-hidden justify-between h-[450px] md:w-[30%] lg:w-[23%] 2xl:w-[15%] flex flex-col mb-10' key={index} style={{boxShadow:'0px 0px 5px -2px #000'}}>
                        ...
                        <div className='flex flex-col'>
                          ...
                          <button className='flex gap-1 cursor-pointer flex-row w-full text-white  bg-green-bt py-2 px-2 justify-center items-center hover:bg-sky-blue transition-all'>
                              ...
                              <Link to={{pathname:'/articles/article', search:`id=${article.id}`}} className='text-[0.9rem] font-bold'>توضیحات بیشتر</Link>
                          </button>
                        </div>
                    </div>
                ))
