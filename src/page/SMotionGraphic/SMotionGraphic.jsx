...
function SMotionGraphic() {
  return (
    ...
    <div className='flex flex-col w-full sm:py-[3rem] py-0'>
      ...
      <EndBox2 content={{p:'جهت مشاهده نمونه کارهای موشن گرافیک توسط تیم نهال آی تی از طریق لینک زیر اقدام کنید',b:'مشاهده نمونه کار موشن گرافیک',link:'/workSamples/graphic/MotionGraphics'}}/>
     </div>
      <div>
        <FixedIcon />
      </div>
