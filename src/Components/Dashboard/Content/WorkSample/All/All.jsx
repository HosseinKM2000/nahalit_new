        ...
        <div className='flex flex-row flex-wrap md:flex-col items-center gap-5'>
            {
                currentItems.map((item,index) => (
                    <div key={index} className='w-full items-center gap-y-1 sm:w-[45%] md:w-[100%] p-3 flex md:flex-row flex-col md:items-center justify-between' style={{background:'linear-gradient(10deg, rgba(86,179,132,1) 0%, rgba(216,233,144,1) 100%)'}}>
