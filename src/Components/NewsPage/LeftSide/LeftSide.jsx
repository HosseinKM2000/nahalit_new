  ...
  return (
    <div className='flex gap-10 w-[90%] my-5 flex-col mt-10 lg:w-[20%]'>
        ...
        <div className='flex flex-row items-center gap-2 2xl:gap-12 text-sm text-gray-66'>
            ...
            <span className='text-[0.9rem] font-[shabnamBold]'>لینک خبر:</span>
        </div>
        ...
        <span className='py-2 px-4 rounded-t-md font-[shabnamBold]' style={{border:'1px solid #D2D2D2'}}>کلمات کلیدی خبر</span>
