...
function MobileSearch({ dropSearchBox , setDropSearchBox }) { 
  ...
  return (
    <div className={dropSearchBox ? "w-[100vw] flex overflow-y-scroll pb-5 scroll_zero items-center flex-col justify-start md:w-[50vw] z-[70] h-screen bg-[#59ce90f8] fixed top-0 right-0 transition-all duration-700" : "w-[100vw] flex items-center flex-col justify-start md:w-[50vw] z-[70] h-screen bg-[#59ce90f8] fixed top-0 right-[-50rem] sm:right-[-60rem] md:right-[-70rem] transition-all duration-700"}>
