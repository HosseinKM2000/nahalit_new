    ...
    <main>
      ...
      <div className='premierEditing-content Services-style flex flex-col items-center gap-10 mb-10'>
        ...
        <div className='flex flex-col w-full sm:my-[5rem] my-[1rem]'>
          ...
          <EndBox2 content={{link:"/workSamples/Premiere",p:'جهت مشاهده نمونه کارهای پریمیر و تدوین فیلم توسط تیم نهال آی تی از طریق لینک زیر اقدام کنید',b:'مشاهده نمونه کار پریمیر و تدوین فیلم',}}/>
        </div>
      <div>
        <FixedIcon />
      </div>
