...
const Article = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center md:items-start lg:flex-row mt-5 w-full lg:w-11/12 overflow-x-hidden text-right gap-2 sm:pr-3'>
        {/* right side */}
        <div className='flex flex-col items-center md:items-start lg:w-[80%]'>
            <ul className='flex flex-row border-y-2 text-xs justify-center md:justify-start border-for-border gap-2 sm:gap-20 py-3'>
            ...
            {/* article-content */}
            <div className='flex flex-col mt-10 2xl:gap-20 w-[90%] md:w-full items-start'>
              <h1 className='text-[1.1rem] mr-2 font-extrabold text-gray-77 '>{goalArticle.title}</h1>
              {/* article-information */}
              ...
              <div className='mt-7 flex flex-col items-center md:inline-block'>
                <img src={goalArticle.img} alt="postIMg" className='w-[80%] sm:w-[50%]  md:w-[50%] float-right ml-0 mb-4 md:ml-4'/>
                <p className='text-gray-66  text-center sm:text-right font-thin text-sm leading-7 px-3'>{text}</p>
              </div>
              {/* socalMedia */}
              ...
              <div className='mt-20 text-gray-66 relative'>
                <span className='font-[shabnambold] px-5 text-[1.2rem] w-fit'>قوانین ارسال دیگاه در سایت</span>
                  ...
                  >
                    {
                      articles.map(article => (
                        <SwiperSlide className='SwiperSlide'>
                          <div className='flex flex-col mb-5 2xl:mb-10 gap-2 2xl:gap-5 rounded-md overflow-hidden' style={{border:'1px solid #CCCCCC'}}>
              ...
              <div className='flex flex-col sm:flex-row w-full 2xl:w-[80%] 2xl:justify-between 2xl:py-5 sm:w-auto  items-center 2xl:p-12 gap-4 sm:gap-32 py-5 px-4 my-10 text-white bg-light-blue'>
               <span className='text-[0.9rem] flex items-center'>راه آسان تری برای ارتباط با کاربرانمان پیدا کرده ایم :)</span>
               <button className='border-2  text-[0.9rem] border-white p-2  btn-telegram transition-all'><Link to='https://telegram.me/nahal_it'>عضویت در کانال </Link></button>
              </div>
              {/* comments */}
              <Comments/>
            </div>
        ...
        <div className='flex gap-10 w-[90%] my-5 flex-col mt-10 lg:w-[20%]'>
          <div className='flex gap-2 flex-col 2xl:gap-12'>
            <div className='flex flex-row items-center gap-2 2xl:gap-12 text-sm text-gray-66'>
              ...
              <span className='text-[0.9rem] font-bold'>لینک کوتاه:</span>
            </div>
