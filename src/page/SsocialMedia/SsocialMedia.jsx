  ...
  return (
    <main>
      ...
      <div className='SocalMedia Services-style flex flex-col items-center gap-10 2xl:gap-20 mb-10'>
        ...
        <EndBox3 content={{link:"/order",p:'جهت سفارش انواع خدمات شبکه های اجتماعی، میتوانید به صورت رایگان ، با شماره تماس بگیرید و یا از طریق لینک زیر اقدام کنید.',b:'سفارش پروژه شبکه های اجتماعی'}}/>
    </div>
      <div>
        <FixedIcon />
      </div>
